...
with st.sidebar.expander("⚙️ Settings"):
    custom_p_buff = st.sidebar.number_input("Pickup Buffer (min)", 120)
    custom_d_buff = st.sidebar.number_input("Del Buffer (min)", 120)
    min_conn = st.sidebar.number_input("Min Conn (min)", 60)
